...
namespace TestMyLib
{
    ...
    class BasicDataTradableTest
    {
        ...
        [Test]
        public void ParseBasicDataTradable2()
        {
            DateTime t1 = new DateTime(2014, 04, 28);
            DateTime t2 = new DateTime(2015, 09, 23);
            string data = "BDt;i1706;SiHITIT.E;s1;Mk288;INiMSPOTEQTHITIT;SYmHITIT.E;NAmHITIT HOLDING A.S.;ISi368;CUiTRY;CUtTRY;PRt1;VOd1;LDa20140428;ITSz78;NDp3;NDTp3;CNyTR;STy1;AUmY;TRaY;PTaY;PTb1;MSe40;LSz1;MLm1;MLt10000000;TRId100;MMk2414,2286,2420,2318,2456;TRmSM;GRsN;";
            BasicDataTradable BDt = new BasicDataTradable(data);
            Assert.AreEqual(1706, BDt.i);
            Assert.AreEqual("HITIT.E", BDt.Si);
            Assert.AreEqual("HITIT.E", BDt.SYm);
            Assert.AreEqual(1, BDt.s);
            Assert.AreEqual(288, BDt.Mk);
            Assert.AreEqual("MSPOTEQTHITIT", BDt.INi);
            Assert.AreEqual("HITIT HOLDING A.S.", BDt.NAm);
            Assert.AreEqual(368, BDt.ISi);
            Assert.AreEqual("TRY", BDt.CUi);
            Assert.AreEqual("TRY", BDt.CUt);
            Assert.AreEqual(1, BDt.PRt);
